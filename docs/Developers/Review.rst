...
But be careful: **bad reviews will scare away other contributors.**
...
unacks like everyone else and ``cobot`` even allows you to set PRs to WIP.
...
Explain why something has to be changed.** Reviewing always involves saying
someone that his code isn't right, be very careful not to appear rude even if
you don't mean it!
